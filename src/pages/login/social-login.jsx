        ...
        >
            ...
            <div className="bg-[#FFFFFF] rounded-xl shadow-lg lg:p-8 p-4 w-full max-w-md z-10 relative">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm text-gray-500 rethink-sans-400">Welcome to Lucoby Design</p>
                </div>
                ...
                <div className="space-y-4 ">
                    ...
                    <button onClick={redirecToLogin} className="w-full bg-[#01575C] text-sm mt-3 rethink-sans-500 text-white rounded-lg py-2 px-4 flex gap-3 cursor-pointer items-center justify-center hover:bg-teal-900 transition-colors">
                        <div>
                ...
                <div className="text-center md:text-md text-sm mt-6 rethink-sans-500 ">
                    ...
                    <Link to={"/social-signup"} className="text-[#17A24A] font-medium hover:underline">
                        Register here!
                    </Link>
                </div>
            </div>
