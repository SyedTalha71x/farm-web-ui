    ...
    <div className="min-h-screen relative">
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-2 mt-1 rethink-sans-400 text-xs text-gray-500">
                    ...
                    <span
                      className={`flex items-center gap-1 px-1.5 py-0.5 rounded-sm text-xs ${
                        task.priority === "High"
                          ? "text-red-600"
      ...
      {selectedTask && (
        <>
          ...
          ></div>
          <div
            className={`w-[320px] bg-white border-l border-gray-200 h-screen fixed right-0 top-0 overflow-y-auto shadow-lg z-50 transition-transform duration-500 ease-in-out ${
          ...
          >
            ...
            <div className="p-4 space-y-4">
              <div className="bg-gray-100 p-4 rounded-md">
                ...
                <h2 className="text-base font-medium">{selectedTask.title}</h2>
              </div>

              <div>
                <h3 className="text-sm text-gray-500 mb-1">Description</h3>
                <textarea
                  className="w-full p-2 text-sm border border-gray-200 rounded-md min-h-[100px] focus:outline-none focus:ring-1 focus:ring-gray-300"
                ...
                <div className="flex gap-2">
                  <button
                    className={`px-3 py-1.5 rounded-md flex items-center gap-1 ${
                      selectedTask.priority === "High" ? "bg-red-500 text-white" : "bg-gray-100 text-gray-700"
                    }`}
                  >
                    <span>High</span>
                  ...
                  <button
                    className={`px-3 py-1.5 rounded-md ${
                      selectedTask.priority === "Medium" ? "bg-orange-500 text-white" : "bg-gray-100 text-gray-700"
                    }`}
                  >
                    Medium
                  </button>
                  <button
                    className={`px-3 py-1.5 rounded-md ${
                      selectedTask.priority === "Low" ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-700"
                    }`}
                  >
                    Low
                  </button>
              ...
              {/* Delete Task */}
              <div className="pt-4">
                <button className="w-full flex items-center justify-center gap-2 text-red-500 border border-red-500 rounded-md py-2">
                  <Trash2 size={16} />
