    ...
    <>
      <div className="flex items-center justify-between mb-6">
        ...
        <div onClick={openModal}>
          <Link className="text-gray-900 rethink-sans-400 cursor-pointer text-sm flex items-center">
        ...
        {showModal && (
          <div className="fixed inset-0 p-2 backdrop-blur-sm rounded-lg bg-black/40 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-lg lg:p-8 p-6 w-90 max-w-md">
              ...
              <p className="text-gray-600 rethink-sans-400 text-center text-sm mb-6 mt-1">
                Unsaved crop changes will be lost. Continue?
              </p>
              ...
              <div className="flex justify-center items-center gap-2">
                ...
                <button
                  ...
                  className="px-6 rethink-sans-400 py-1.5 text-sm bg-[#01575C] text-white rounded hover:bg-teal-700"
                >
                  Discard
                </button>
              </div>
          ...
          <div className="mb-6">
            ...
            <div className="hidden md:flex justify-between items-center mb-6">
              <div className="flex items-center justify-start">
                ...
                <div
                  className={`h-0.5 w-13 mx-2 ${
                    activeStep === "plant-info" || completedSteps.includes("plant-type")
                      ? "bg-green-500"
                      : "bg-gray-200"
                  }`}
                ></div>
                ...
                <div
                  className={`h-0.5 w-13 mx-2 ${
                    activeStep === "harvest-info" || completedSteps.includes("plant-info")
                      ? "bg-green-500"
                      : "bg-gray-200"
                  }`}
                ></div>
