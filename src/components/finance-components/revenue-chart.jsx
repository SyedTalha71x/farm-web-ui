    ...
    <div className="bg-white rounded-lg p-5 border border-slate-200/70  w-full max-w-3xl">
      <div className="flex justify-between items-start mb-4">
        <div>
          ...
          <h2 className="text-lg  rethink-sans-700 text-gray-900">Revenue: </h2>
          <h2 className="text-lg  rethink-sans-700 text-gray-900">17 Nov - 17 Dec</h2>
            </div>
        ...
        <div className="flex rethink-sans-400 items-center text-sm text-gray-500">
          <span className='bg-[#F1F4F5] py-1.5 px-5 md:w-auto w-full rounded-md cursor-pointer text-xs'>Last 30 Days</span>
