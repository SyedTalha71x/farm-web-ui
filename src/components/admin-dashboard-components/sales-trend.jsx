  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-5 max-w-xl">
      <div className="flex justify-between items-start mb-4">
        <div>
          <h2 className="text-xl rethink-sans-700 text-gray-900">Sales Trend</h2>
          <p className="text-sm text-gray-500 rethink-sans-400">4,235 more compared to last period sales</p>
        </div>
