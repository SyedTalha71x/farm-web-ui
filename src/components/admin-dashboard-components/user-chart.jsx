      ...
      <div className="flex justify-between items-start mb-4">
        <div>
          <div className='flex md:flex-row flex-col md:gap-2 gap-0'>
            ...
            <h2 className="text-lg  rethink-sans-700 text-gray-900">User Engagement</h2>
          </div>
          <p className="text-sm text-gray-500 rethink-sans-500">88,235 more compared to last period engagement</p>
        </div>
...
export default UserEngagmentChart;
